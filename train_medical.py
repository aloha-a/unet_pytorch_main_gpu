...
from unetgputest.unet_pytorch_main_gpu.nets.unet import Unet
...
from unetgputest.unet_pytorch_main_gpu.utils.utils import (download_weights, seed_everything, show_config,
                         worker_init_fn)
...
if __name__ == "__main__":
    ...
    #   数据集路径
    #------------------------------#
    VOCdevkit_path  = '/kaggle/input/unetgputest/unet_pytorch_main_gpu/Medical_Datasets'
    #------------------------------------------------------------------#
    #   建议选项：
    #   种类少（几类）时，设置为True
